...
export default function About() {
  const allSkills = portfolioData.skills.flatMap(
    (s) => s.items
  );
      ...
      <div className="content max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-snug text-center lg:text-left">
            ...
            <div className="mt-8">
              ...
              <h4 className="font-semibold text-white text-lg mb-4 text-center lg:text-left">
                Core Competencies
              </h4>
